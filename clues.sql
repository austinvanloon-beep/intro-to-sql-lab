...
WHERE countrycode = (
  SELECT code
  FROM countries
  WHERE name = 'PUT CLUE3 COUNTRY NAME HERE'
)
AND name <> 'PUT CLUE3 COUNTRY NAME HERE';
...
FROM cities
WHERE name LIKE 'PUT CLUE4 CITY NAME%'
AND name <> 'PUT CLUE4 CITY NAME';
...
SELECT capital
FROM countries
WHERE code = 'PUT CLUE5 COUNTRY CODE HERE';
...
SELECT name
FROM cities
WHERE population > 91000 AND population < 91085;
